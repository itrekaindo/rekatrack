...
@section('title', 'Laporan Bukti Pengiriman - Rekatrack')
        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="d-flex align-items-center">
              ...
              <div>
                <h4 class="fw-bold mb-1">{{ $travelDocument->no_travel_document ?? '-' }}</h4>
          ...
          <div class="col-md-4 text-end">
            <span class="badge badge-success badge-lg">
              <i class="fa fa-check me-1"></i> {{ $travelDocument->status ?? '-' }}
            </span>
          </div>
        </div>
      </div>
        ...
        <div class="mb-3">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-fill">
              ...
              <h5 class="fw-bold mb-0">{{ $travelDocument->no_travel_document ?? '-' }}</h5>
            </div>
          </div>
        </div>
            ...
            <div class="flex-fill">
              ...
              <h5 class="fw-bold mb-0">
                @if($travelDocument->posting_date)
                  {{ \Carbon\Carbon::parse($travelDocument->posting_date)
                    ->locale('id')
        ...
        <div class="mb-3">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-fill">
              ...
              <h5 class="fw-bold mb-0">{{ $confirmation->receiver_name ?? '-' }}</h5>
            </div>
          </div>
        </div>
        ...
        <div class="mb-3">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-fill">
              ...
              <h5 class="fw-bold mb-0">{{ $confirmation->received_at ?? '-' }}</h5>
            </div>
          </div>
        </div>
        ...
        <div>
          <div class="d-flex align-items-center">
            ...
            <div class="flex-fill">
              ...
              <h5 class="fw-bold mb-0">{{ $startTime ?? '-' }}</h5>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <div class="text-center p-3 border rounded bg-light">
                @if(!empty($confirmation->photo_path))
                  <img src="{{ asset('storage/'.$confirmation->photo_path) }}"
              ...
              <div class="p-3 border rounded bg-light" style="min-height: 200px;">
                @if(!empty($confirmation->note))
                  <div class="d-flex">
                    ...
                    <div class="flex-fill">
                      <p class="mb-0">{{ $confirmation->note }}</p>
                    </div>
                  </div>
                @else
    ...
    {{-- <div class="card"> --}}
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <a href="{{ route('shippings.detail', $travelDocument->id) }}" class="btn btn-light btn-round">
          ...
          <div class="d-flex gap-2">
            ...
            <a href="{{ route('shippings.index') }}" class="btn btn-secondary btn-round">
