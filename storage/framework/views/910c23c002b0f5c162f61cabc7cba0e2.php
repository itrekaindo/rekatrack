              ...
              <div class="max-w-full overflow-x-auto">
                  ...
                  <tbody id="shipping-table-body" class="divide-y divide-gray-100 dark:divide-gray-800">
                    <?php $__currentLoopData = $listTravelDocument; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td class="px-5 py-4 sm:px-6">
                          <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e(\Carbon\Carbon::parse($data->date_no_travel_document)->format('d/m/Y')); ?></p>
                        </td>
                        <td class="px-5 py-4 sm:px-6">
                          <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($data->send_to); ?></p>
                        </td>
                        <td class="px-5 py-4 sm:px-6">
                        ...
                        <td class="px-5 py-4 sm:px-6">
                          <div class="flex space-x-2">
                            <form action="<?php echo e(route('shippings.detail', ['id' => $data['id']])); ?>" method="GET">
                              <button type="submit" class="text-blue-600 dark:text-blue-400 hover:underline">detail</button>
                            </form>
                            <form action="<?php echo e(route('shippings.destroy', ['id' => $data['id']])); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus?');">
                              <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6 dark:border-gray-800 dark:bg-white/[0.03]">
                  <p class="text-sm text-gray-500 dark:text-gray-300 mb-2 sm:mb-0">
                    Menampilkan <?php echo e($listTravelDocument->firstItem()); ?> ke <?php echo e($listTravelDocument->lastItem()); ?> dari total <?php echo e($listTravelDocument->total()); ?> data
                  </p>
                  <div>
                    <?php echo e($listTravelDocument->links('pagination::tailwind')); ?>
